...
@Component({
    ...
    template: `
        <form class="ui large form segment">
            ...
            <button (click)="addArticle(newtitle, newlink, newdescription)" class="ui positive right floated button">
                Submit Link
            </button>
        </form>
...
class RedditApp {
    ...
    constructor() {
        this.articles = [
            new Article('Angular 2', 'http://angular.io', 'dolor is amet',  3),
            new Article('Fullstack', 'http://fullstack.io', 'dolor is amet', 2),
            new Article('Angular Homepage', 'http://angular.io', 'dolor is amet', 1),
        ];
    }

    addArticle(title: HTMLInputElement, link: HTMLInputElement, description: HTMLInputElement): boolean {
        console.log(`Adding article title: ${title.value}, link: ${link.value}  and description: ${description.value}`);
