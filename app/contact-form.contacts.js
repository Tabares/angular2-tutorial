        ...
        execute: function() {
            ContactComponent = (function () {
                function ContactComponent() {
                    this.countries = ['Mexico', 'Australia', 'Spain', 'Italy'];
                    this.contact = new contact_1.Contact('Emmanuel', 'Tabares', this.countries[0], 8119050506);
...
//# sourceMappingURL=contact-form.contacts.js.map